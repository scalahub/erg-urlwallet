...
<%
	String urlPattern = request.getParameter("secretData");
	...
	msg = org.UrlWallet.Wallet.urlWallet().processSend(urlPattern, addressesToSend, amtsToSend, tokensToSend, tokenIdsToSend, fee, inputBoxId, copyTo, allowTokenBurn, optimizeInputs,inputBoxIndex);
   } catch(Exception e) {
       e.printStackTrace();
